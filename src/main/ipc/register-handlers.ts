...
export const registerIpcHandlers = (
  input: RegisterIpcHandlersInput
  ...
  const runTask = async (
    ...
    try {
      ...
      const modelHint = result.usedModel
        ? `model=${result.provider}/${result.model}`
        : "model=local";
      const outputPreview = result.outputText
        .replace(/\s+/g, " ")
        .slice(0, 360);
  ...
  ipcMain.handle(
    "chat:send",
    async (_event, chatInput: ChatSendInput): Promise<ChatSendResult> => {
      const requestId =
        chatInput.requestId?.trim() ||
  ...
  ipcMain.handle(
    "chat:cancel",
    async (_event, cancelInput: ChatCancelInput): Promise<ChatCancelResult> => {
  ...
  ipcMain.handle(
    "config:get-storage-info",
    async (): Promise<ConfigStorageInfoResult> => {
      return {
        userConfigPath: input.config.paths.userConfigPath,
        configDir: input.config.paths.configDir,
        notes:
          "Config source: defaults + project(optional) + userConfig. .env and config env overrides are disabled.",
      };
    }
  );
  ...
  ipcMain.handle(
    ...
    async (): Promise<OpenConfigDirResult> => {
  ...
  ipcMain.handle(
    "config:get-settings-state",
    async (): Promise<GlobalSettingsState> => {
      return input.settingsService.getState();
    }
  );

  ipcMain.handle(
    "config:save-settings-state",
    async (
      _event,
      saveInput: SaveSettingsInput
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      listInput: ModelsCatalogListInput = {}
    ): Promise<ModelsCatalogListResult> => {
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      connectInput: ModelsConnectInput
    ): Promise<ModelsConnectResult> => {
  ...
  ipcMain.handle(
    ...
    async (): Promise<ModelsListConnectedResult> => {
      return input.modelOnboardingService.listConnected();
    }
  );

  ipcMain.handle(
    "models:set-chat-default",
    async (
      _event,
      setInput: ModelsSetDefaultInput
    ): Promise<ModelsOperationResult> => {
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      credentialInput: ModelsUpdateCredentialInput
    ): Promise<ModelsOperationResult> => {
      return input.modelOnboardingService.updateProviderCredential(
        credentialInput
      );
    }
  );
  ...
  ipcMain.handle(
    "conversation:get",
    async (_event, id: string): Promise<ConversationResult | null> => {
  ...
  ipcMain.handle(
    "message:create",
    async (_event, messageInput: MessageInput): Promise<MessageResult> => {
  ...
  ipcMain.handle(
    "message:list",
    async (_event, conversationId: string): Promise<MessageResult[]> => {
  ...
  ipcMain.handle(
    "task:start",
    async (_event, taskInput: TaskStartInput): Promise<TaskStartResult> => {
  ...
  ipcMain.handle(
    "sandbox:list-dir",
    async (_event, listDirInput: SandboxListDirInput) => {
  ...
  ipcMain.handle(
    "sandbox:read-file",
    async (_event, readFileInput: SandboxReadFileInput) => {
  ...
  ipcMain.handle(
    "sandbox:write-file",
    async (_event, writeFileInput: SandboxWriteFileInput) => {
  ...
  ipcMain.handle(
    "sandbox:exec",
    async (_event, execInput: SandboxExecInput) => {
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      resourceInput: MemoryAddResourceInput
    ): Promise<MemoryAddResourceResult> => {
      const ov = input.getOpenViking();
      if (!ov.httpClient) {
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      listInput: MemoryListResourcesInput
    ): Promise<MemoryListResourcesResult> => {
      const ov = input.getOpenViking();
      if (!ov.httpClient) {
        throw new Error("OpenViking is not running");
      }
      ...
      return {
        entries: result.map((entry) => {
          ...
          const fallbackName =
            uriStr.split("/").filter(Boolean).pop() ?? uriStr;
          return {
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      deleteInput: MemoryDeleteResourceInput
    ): Promise<MemoryDeleteResourceResult> => {
      const ov = input.getOpenViking();
      if (!ov.httpClient) {
        throw new Error("OpenViking is not running");
      }
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      readInput: MemoryReadResourceInput
    ): Promise<MemoryReadResourceResult> => {
      const ov = input.getOpenViking();
      if (!ov.httpClient) {
        throw new Error("OpenViking is not running");
      }
  ...
  ipcMain.handle(
    "soul:update",
    async (_event, updateInput: SoulUpdateInput) => {
  ...
  ipcMain.handle(
    "soul:interview",
    async (_event, interviewInput: SoulInterviewInput) => {
      ...
      const result = await input.modelsFactory.generateText({
        ...
        ...(history.length > 0
          ...
          : {
              prompt:
                "Start the interview. Greet the user and ask your first question.",
            }),
  ...
  ipcMain.handle(
    "soul:interview:summarize",
    async (_event, summarizeInput: SoulInterviewSummarizeInput) => {
      const target = resolveRuntimeTarget(input.config, "lead.planner");
  ...
  ipcMain.handle(
    "skills:create",
    async (_event, createInput: SkillCreateInput) => {
  ...
  ipcMain.handle(
    "skills:update",
    async (_event, name: string, updateInput: SkillUpdateInput) => {
  ...
  ipcMain.handle(
    "skills:toggle",
    async (_event, toggleInput: SkillToggleInput) => {
  ...
  ipcMain.handle(
    "cron:create",
    async (_event, createInput: CronCreateInput) => {
  ...
  ipcMain.handle(
    "cron:update",
    async (_event, updateInput: CronUpdateInput) => {
  ...
  ipcMain.handle(
    "cron:delete",
    async (_event, deleteInput: CronDeleteInput) => {
  ...
  ipcMain.handle(
    "cron:run-now",
    async (_event, runNowInput: CronRunNowInput) => {
  ...
  ipcMain.handle(
    "cron:history",
    async (_event, historyInput: CronHistoryInput) => {
      const records = await input.cronService.getHistory(
        historyInput.jobId,
        historyInput.limit
      );
      return { records };
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      createDirInput: UserFilesCreateDirInput
    ): Promise<UserFilesCreateDirResult> => {
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      saveInput: UserFilesSaveInput
    ): Promise<UserFilesSaveResult> => {
      const record = await input.userFilesService.saveFile(
        saveInput.filePath,
        saveInput.content
      );
      return { record };
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      listInput: UserFilesListInput
    ): Promise<UserFilesListResult> => {
      const entries = await input.userFilesService.listDirectory(
        listInput.dirPath
      );
      return { entries };
    }
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      readInput: UserFilesReadInput
    ): Promise<UserFilesReadResult> => {
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      deleteInput: UserFilesDeleteInput
    ): Promise<UserFilesDeleteResult> => {
      await input.userFilesService.delete(
        deleteInput.filePath,
        deleteInput.recursive ?? false
      );
      return { ok: true };
    }
  );
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      renameInput: UserFilesRenameInput
    ): Promise<UserFilesRenameResult> => {
      await input.userFilesService.rename(
        renameInput.oldPath,
        renameInput.newPath
      );
      return { ok: true };
  ...
  ipcMain.handle(
    "userFiles:saveConversation",
    async (
      _event,
      saveConvInput: UserFilesSaveConversationInput
    ): Promise<UserFilesSaveConversationResult> => {
  ...
  ipcMain.handle(
    ...
    async (
      _event,
      statsInput: ConversationTokenStatsInput
    ): Promise<ConversationTokenStatsResult> => {
      return input.conversationStore.getConversationTokenStats(
        statsInput.conversationId
      );
    }
  );
